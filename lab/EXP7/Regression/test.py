...
画原始数据曲线图
'''
data.plot(kind='scatter', x='人口', y='收益', figsize=(8,6))
...
def computeCost(X, y, w):
    inner = np.power((np.matmul(X, w) - y), 2) # power平方, matmul矩阵相乘
...
k = [0.1, 0.2]
b = 0.01
kx+b = [0.1, 0.2] * [3, 4] = [0.01, 0.1, 0.2] * [1, 3, 4]
     = [b, k0, k1] * [1, x1, x2] = b + k0*x0 + k1*x1 = b + kx 
